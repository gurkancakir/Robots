...
public class CollisionGeometry {
	 ...
	 * 
	 * @param runs
	 *            the model-space rectangles that make up this object's
	 *            collision geometry.
	 */
	...
	/**
	 * Tests if this collision geometry would collide with a rectangle if it was
	 * at the given coordinates.
	 * 
	 * @param other
	 *            the rectangle to test against.
	 * @param x
	 *            the x coordinate of this collision geometry.
	 * @param y
	 *            the y coordinate of this collision geometry.
	 ...
	 * 
	 * @param x
	 *            this collision geometry's x coordinate.
	 * @param y
	 *            this collision geometry's y coordinate.
	 * @param other
	 *            the other collision geometry.
	 * @param otherX
	 *            the other collision geometry's x coordinate.
	 * @param otherY
	 *            the other collision geometry's y coordinate.
	 * @return true if in collision otherwise false.
	 */
