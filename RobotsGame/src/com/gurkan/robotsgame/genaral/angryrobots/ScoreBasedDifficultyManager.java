...
public class ScoreBasedDifficultyManager implements DifficultyManager,ScoreListener {
	...
	private static final int INITIAL_ROBOTS = Config.asInt(
			"Global.initialRobots", 6);

	// Shot speeds.
	private static final float SLOW_SHOT_SPEED = Config.asFloat(
			"RobotShot.slowSpeed", 75.0f);
	private static final float FAST_SHOT_SPEED = Config.asFloat(
			"RobotShot.fastSpeed", 125.0f);

	// Level progression.
	private static final int ROBOT_INCREMENT = Config.asInt(
			"Level.robotIncrement", 3);
	private static final int LEVEL_0_ROBOT_SHOTS = Config.asInt(
			"Level.0.robotShots", 0);
	private static final int LEVEL_1_ROBOT_SHOTS = Config.asInt(
			"Level.1.robotShots", 1);
	private static final int LEVEL_2_ROBOT_SHOTS = Config.asInt(
			"Level.2.robotShots", 2);
	private static final int LEVEL_3_ROBOT_SHOTS = Config.asInt(
			"Level.3.robotShots", 3);
	private static final int LEVEL_4_ROBOT_SHOTS = Config.asInt(
			"Level.4.robotShots", 4);
	private static final int LEVEL_5_ROBOT_SHOTS = Config.asInt(
			"Level.5.robotShots", 5);
	private static final int LEVEL_6_ROBOT_SHOTS = Config.asInt(
			"Level.6.robotShots", 1);
	private static final int LEVEL_7_ROBOT_SHOTS = Config.asInt(
			"Level.7.robotShots", 2);
	private static final int LEVEL_8_ROBOT_SHOTS = Config.asInt(
			"Level.8.robotShots", 3);
	private static final int LEVEL_9_ROBOT_SHOTS = Config.asInt(
			"Level.9.robotShots", 4);
	private static final int LEVEL_10_ROBOT_SHOTS = Config.asInt(
			"Level.10.robotShots", 5);
	private static final int LEVEL_11_ROBOT_SHOTS = Config.asInt(
			"Level.11.robotShots", 6);
	...
	private static final int LEVEL_3_SCORE = Config
			.asInt("Level.3.score", 1000);
	private static final int LEVEL_4_SCORE = Config
			.asInt("Level.4.score", 2500);
	private static final int LEVEL_5_SCORE = Config
			.asInt("Level.5.score", 5000);
	private static final int LEVEL_6_SCORE = Config
			.asInt("Level.6.score", 7500);
	private static final int LEVEL_7_SCORE = Config.asInt("Level.7.score",
			10000);
	private static final int LEVEL_8_SCORE = Config.asInt("Level.8.score",
			12500);
	private static final int LEVEL_9_SCORE = Config.asInt("Level.9.score",
			15000);
	private static final int LEVEL_10_SCORE = Config.asInt("Level.10.score",
			17500);
	private static final int LEVEL_11_SCORE = Config.asInt("Level.11.score",
			20000);
