...
/**
 * All game objects are ultimately based on <code>GameObject</code>. Different
 * behaviours are specified by overriding {@link GameObject#update}.
 * 
 * @author Rod
 */
public class GameObject {
	...
	/**
	 * This game object's collision geometry (if it has any) in local
	 * coordinates.
	 */
	...
	/**
	 * Updates this game object. Typically you would override this to create
