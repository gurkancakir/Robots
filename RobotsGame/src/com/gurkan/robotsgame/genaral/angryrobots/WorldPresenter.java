...
import com.gurkan.robotsgame.genaral.angryrobots.WorldView.Presenter;
...
/**
 * <p>
 * It is the role of the <code>WorldPresenter</code> to glue together the
 * {@link World} and the {@link WorldView}. It passes on information from the
 * controls in the WorldView to the World, updates it, then asks the WorldView
 * to draw everything on its behalf. The {@link WorldView} tells this
 * <code>WorldPresenter</code> what to do via the methods provided by the
 * {@link Presenter} interface.
 * </p>
 * 
 * @author Rod
 */
public class WorldPresenter extends GameScreen<VeryAngryRobotsGame> implements
		WorldView.Presenter, ScoreListener {
	 ...
	 * 
	 * @param game
	 *            the game, used primarily for switching between screens.
	 */
	...
	/**
	 * Called by libgdx when this screen should render itself. It responds to a
	 * request to render by updating the controls, updating the world and the
	 * managers, then drawing the views.
	 * 
	 * @param delta
	 *            the time in seconds since the last time <code>render</code>
	 *            was called.
	 */
	@Override
	 ...
	 * 
	 * @param x
	 *            the x value of the controller.
	 * @param y
	 *            the y value of the controller.
	 */
	@Override
